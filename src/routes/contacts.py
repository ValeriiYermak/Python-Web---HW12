...
from src.schemas.contacts import ContactResponse, ContactUpdateSchema, ContactSchema
...
@router.get(
    "/", response_model=List[ContactResponse], response_model_exclude_unset=True
)
async def get_contacts(
    ...
    contacts = await repository_contacts.get_contacts(limit, offset, query, db, user)
    return contacts
...
async def get_all_contacts(
    ...
    contacts = await repository_contacts.get_all_contacts(limit, offset, query, db)
    return contacts
